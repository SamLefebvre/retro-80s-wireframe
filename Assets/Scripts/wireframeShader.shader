// From : https://github.com/UnityCommunity/UnityLibrary/blob/master/Assets/Shaders/2D/Effects/WireFrame.shader
// Version : 1dbe5d8 on 25 Nov 2017
...
//				UNITY_INITIALIZE_OUTPUT(v2g, o);
			...
			void geom(triangle v2g i[3], inout TriangleStream<g2f> triangleStream)
			{
				...
				//o.dist.xyz = float3( 1, 0.0, 0.0) * o.projectionSpaceVertex.w * wireThickness;
				...
				//o.dist.xyz = float3(0.0, 0.0, 90000) ;
